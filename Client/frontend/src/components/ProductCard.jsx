...
const ProductCard = ({ product }) => {
    ...
    return (
        // Changed to flex-row and increased overall card width/height for new layout
        <Card className="max-w-xs h-48 flex flex-row items-stretch overflow-hidden p-0"> 
            {/* Image Container */}
            <div className="w-2/5 flex-shrink-0"> {/* Take 40% width, don't shrink */}
                <img
                    // Removed rounded-t-lg and h-28. Now full height and object-cover within its div
            ...
            {/* Content Container - Flexed to the right */}
            <div className="w-3/5 px-3 py-2 flex flex-col justify-between flex-grow"> {/* Take 60% width */}
                <h5 className="text-sm font-semibold tracking-tight text-gray-900 dark:text-white mb-0.5 leading-tight line-clamp-2"> 
                    {product.name || 'Untitled Product'}
                </h5>
                <span className="text-base font-bold text-gray-900 dark:text-white mb-1">
