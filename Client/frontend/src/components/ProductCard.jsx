...
const ProductCard = ({ product }) => {
    ...
    return (
        ...
        // </Card>
                ...
                <Card className="max-w-[200px] h-[360px] flex flex-col justify-between overflow-hidden shadow-lg">
            <img
                className="rounded-t-lg w-full object-contain h-52 bg-white p-2"
                src={product.imageUrl}
                alt={product.name || 'Product Image'}
            />
